## what is this
it's a script that sends midi messages based on some VR movement. You need openvr_api.dll in the same directory as vrlin.exe to run it, and SteamVR has to be already running.
